      ...
      <div className="w-full bg-white p-6 md:p-8 rounded-[32px] border border-[#e8ded2] shadow-[0_8px_30px_rgb(0,0,0,0.06)] animate-in fade-in duration-500">
        ...
        >
            ...
            <div>
              <div className="relative">
                ...
                <input
                  ...
                  className="h-11 w-full rounded-xl border border-[#e8ded2] bg-white pl-12 pr-4 text-[15px] text-[#2c150c] focus:outline-none focus:border-[#5c1417] focus:ring-1 focus:ring-[#5c1417] transition-all"
                  {...register("fullName")}
                />
              </div>
              {errors.fullName && (
                <p className="text-sm text-red-600 ml-2 mt-1">
            ...
            <div>
              <div className="relative">
                ...
                <input
                  ...
                  className="lowercase h-11 w-full rounded-xl border border-[#e8ded2] bg-white pl-12 pr-4 text-[15px] text-[#2c150c] focus:outline-none focus:border-[#5c1417] focus:ring-1 focus:ring-[#5c1417] transition-all"
                  {...register("email")}
                />
              </div>
              {errors.email && (
            ...
            <div>
              <div className="relative">
                ...
                <input
                  ...
                  className="h-11 w-full rounded-xl border border-[#e8ded2] bg-white pl-12 pr-12 text-[15px] text-[#2c150c] focus:outline-none focus:border-[#5c1417] focus:ring-1 focus:ring-[#5c1417] transition-all"
                  {...register("password")}
                />
                <button
                  type="button"
          ...
          <label className="flex items-start gap-3 cursor-pointer text-[13px] text-[#5c4a42] font-medium">
            <input
              type="checkbox"
              className="mt-0.5 h-4 w-4 rounded border-[#e8ded2] text-[#5c1417] focus:ring-[#5c1417]"
              {...register("agreed")}
            />
            <span className="leading-tight">
              ...
              <Link
                to="/terms"
                className="font-bold text-[#5c1417] hover:underline"
              >
                Terms of Service
              </Link>{" "}
              &{" "}
          ...
          {formError && (
            <p className="text-[15px] text-red-600 bg-red-50 p-2 rounded-lg text-center">
              {formError}
            </p>
          )}
          ...
          <button
            ...
            className="w-full h-11 rounded-xl bg-[#5c1417] hover:bg-[#470f12] text-white font-semibold text-[17px] shadow-md transition-colors flex justify-center items-center"
          >
            {isSubmitting ? (
          ...
          <div className="relative flex items-center justify-center w-full my-1">
            ...
            <span className="absolute bg-[#f9f1e8] px-4 py-0.5 text-xs font-bold text-[#5a4a44] uppercase tracking-widest rounded-full">
              Or
            </span>
          </div>
          ...
          <button
            ...
            className="w-full h-11 rounded-xl border border-[#e8ded2] bg-white hover:bg-stone-50 text-[#2c150c] font-semibold text-[15px] flex items-center justify-center gap-3 shadow-sm transition-all"
          >
            {googleLoading ? (
              <span className="animate-spin h-5 w-5 border-2 border-[#8c746a] border-t-[#2c150c] rounded-full" />
            ) : (
              <>
