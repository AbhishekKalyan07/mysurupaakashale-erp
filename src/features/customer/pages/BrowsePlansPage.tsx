  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="text-center mb-12">
        ...
        <p className="text-stone-600 max-w-2xl mx-auto text-lg font-sans">
          ...
          return (
            <Card
              ...
              className={`relative flex flex-col justify-between overflow-hidden border-2 transition-all hover:shadow-xl ${
                isRegular
                  ? 'border-emerald-600 shadow-md bg-stone-50/50'
                  : 'border-stone-200'
              }`}
            >
              {isRegular && (
              ...
              <div className={`p-6 md:p-8 ${isRegular ? 'pt-10' : ''}`}>
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <h2 className="text-2xl font-serif font-bold text-stone-900">{plan.name}</h2>
                    <p className="text-stone-500 text-sm font-sans mt-1">{plan.description}</p>
                  </div>
                ...
                <div className="my-6">
                  <div className="flex items-baseline font-sans">
                    <span className="text-4xl font-extrabold text-stone-900">₹{plan.pricePerDay}</span>
                    <span className="text-stone-500 ml-2 text-base">/ day</span>
                  </div>
                  <p className="text-xs text-stone-400 font-sans mt-1">Billed monthly (includes 3 deliveries daily)</p>
                </div>

                <div className="border-t border-stone-200/80 my-6 pt-6">
                  <h3 className="text-stone-800 font-semibold font-sans mb-4 flex items-center gap-2">
                    <ShieldCheck size={18} className="text-emerald-600" /> What's Included:
                  </h3>
                  <ul className="space-y-3 font-sans text-stone-600 text-sm">
