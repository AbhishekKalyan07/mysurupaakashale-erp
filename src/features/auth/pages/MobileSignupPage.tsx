        ...
        >
            ...
            <div>
              <div className="relative">
                ...
                <input
                  ...
                  className="h-12 w-full rounded-xl border border-[#e8ded2] bg-white pl-11 pr-4 text-sm text-[#2c150c] focus:outline-none focus:border-[#5c1417] focus:ring-1 focus:ring-[#5c1417]"
                  {...register("fullName")}
                />
              </div>
              {errors.fullName && (
                <p className="text-[10px] text-red-600 ml-2 mt-1">
            ...
            <div>
              <div className="relative">
                ...
                <input
                  ...
                  className="lowercase h-12 w-full rounded-xl border border-[#e8ded2] bg-white pl-11 pr-4 text-sm text-[#2c150c] focus:outline-none focus:border-[#5c1417] focus:ring-1 focus:ring-[#5c1417]"
                  {...register("email")}
                />
              </div>
              {errors.email && (
            ...
            <div>
              <div className="relative">
                ...
                <input
                  ...
                  className="h-12 w-full rounded-xl border border-[#e8ded2] bg-white pl-11 pr-10 text-sm text-[#2c150c] focus:outline-none focus:border-[#5c1417] focus:ring-1 focus:ring-[#5c1417]"
                  {...register("password")}
                />
                <button
                  type="button"
          ...
          <label className="flex items-start gap-2.5 cursor-pointer text-[11px] text-[#5c4a42] font-medium mt-1">
            ...
            <span className="leading-tight">
              I agree to the{" "}
              <Link to="/terms" className="font-bold text-[#5c1417] underline">
                Terms of Service
              </Link>{" "}
              &{" "}
              <Link
                to="/privacy"
                className="font-bold text-[#5c1417] underline"
              >
                Privacy Policy
              </Link>
            </span>
          ...
          <button
            ...
            className="w-full h-12 rounded-xl bg-[#5c1417] hover:bg-[#470f12] text-white font-semibold text-base shadow-md transition-colors mt-2 flex justify-center items-center"
          >
            {isSubmitting ? (
          ...
          <button
            ...
            className="w-full h-12 rounded-xl border border-[#e8ded2] bg-white text-[#2c150c] font-semibold text-sm flex items-center justify-center gap-3 shadow-sm"
          >
            {googleLoading ? (
              <span className="animate-spin h-4 w-4 border-2 border-[#8c746a] border-t-[#2c150c] rounded-full" />
            ) : (
              <>
