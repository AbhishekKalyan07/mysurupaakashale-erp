...
export const orderRepository = {
  ...
  getCustomerOrdersInRange: async (
    customerId: string,
    startDate: string,
    endDate: string,
  ) => {
...
export const notificationService = {
  ...
  notifyOrderGeneratedCustomer: async (
    _customerId: string,
    _orderId: string,
    _mealType: string,
    _date: string,
  ...
  notifyOrderGeneratedDriver: async (
    _driverId: string,
    _orderId: string,
    _mealType: string,
  ) => {
  ...
  notifyDailyOrdersGenerated: async (
    adminIds: string[],
    date: string,
    count: number,
  ) => {
    logger.info(
      `Admin notification: ${count} daily orders generated for ${date}.`,
    );
  },
};
