...
export const PremiumCard = forwardRef<HTMLDivElement, PremiumCardProps>(
  (
    { className, hoverLift = false, elevated = false, children, ...props },
    ref,
  ) => {
    return (
      <div
        ...
        className={cn(
          ...
          hoverLift &&
            "transition-all duration-200 hover:-translate-y-1 hover:shadow-lg hover:border-border-strong cursor-pointer",
          className,
        )}
        {...props}
      >
