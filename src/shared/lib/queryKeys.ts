...
export const queryKeys = {
  ...
  subscriptions: {
    ...
    byCustomer: (customerId: string) =>
      ["subscriptions", "customer", customerId] as const,
    active: (customerId: string) =>
      ["subscriptions", "active", customerId] as const,
  ...
  payments: {
    ...
    adminList: (status: string, page: number | string) =>
  ...
  notifications: {
    ...
    adminHistory: (page: number) =>
      ["notifications", "admin", "history", page] as const,
    detail: (id: string) => ["notifications", "detail", id] as const,
  },
  kitchen: {
    base: ["kitchen"] as const,
    dayOrders: (date: string, kitchenId: string = "all") =>
      ["kitchen", "orders", date, kitchenId] as const,
    dashboard: (date: string, kitchenId: string) =>
      ["kitchen", "dashboard", date, kitchenId] as const,
    dailyMenu: (date: string) => ["kitchen", "dailyMenu", date] as const,
    dailyMenuList: ["kitchen", "dailyMenus"] as const,
    dailyMenuDetail: (id: string) =>
      ["kitchen", "dailyMenus", "detail", id] as const,
    mealTypeOrders: (date: string, mealType: string) =>
      ["kitchen", "orders", date, mealType] as const,
  },
  delivery: {
    base: ["delivery"] as const,
    unassignedOrders: (date: string) =>
      ["delivery", "unassigned", date] as const,
    assignedOrders: (date: string) => ["delivery", "assigned", date] as const,
    partnerOrders: (partnerId: string, date: string) =>
      ["delivery", "partner", partnerId, date] as const,
  },
  accounts: {
    base: ["accounts"] as const,
    payments: (start: string, end: string) =>
      ["accounts", "payments", start, end] as const,
    invoices: (start: string, end: string) =>
      ["accounts", "invoices", start, end] as const,
    invoicesByCustomer: (customerId: string) =>
      ["accounts", "invoices", "customer", customerId] as const,
    orders: (start: string, end: string) =>
      ["accounts", "orders", start, end] as const,
  },
  users: {
    all: ["users"] as const,
  },
