...
const StaffManagementPage = lazy(() =>
  import("@/features/admin/pages/StaffManagementPage").then((m) => ({
    default: m.StaffManagementPage,
  })),
);
const BusinessSettingsPage = lazy(() =>
  import("@/features/admin/pages/BusinessSettingsPage").then((m) => ({
    default: m.BusinessSettingsPage,
  })),
);
const AuditLogsPage = lazy(() =>
  import("@/features/admin/pages/AuditLogsPage").then((m) => ({
    default: m.AuditLogsPage,
  })),
);
const PaymentVerificationPage = lazy(() =>
  import("@/features/admin/pages/PaymentVerificationPage").then((m) => ({
    default: m.PaymentVerificationPage,
  })),
);
const AdminCustomersPage = lazy(() =>
  import("@/features/admin/pages/AdminCustomersPage").then((m) => ({
    default: m.AdminCustomersPage,
  })),
);
const AdminSubscriptionsPage = lazy(() =>
  import("@/features/admin/pages/AdminSubscriptionsPage").then((m) => ({
...
const AdminKitchenPage = lazy(() =>
  import("@/features/admin/pages/AdminKitchenPage").then((m) => ({
    default: m.AdminKitchenPage,
  })),
);
const AdminAccountsPage = lazy(() =>
  import("@/features/admin/pages/AdminAccountsPage").then((m) => ({
    default: m.AdminAccountsPage,
  })),
);
const AdminComplaintsPage = lazy(() =>
  import("@/features/admin/pages/AdminComplaintsPage").then((m) => ({
    default: m.AdminComplaintsPage,
  })),
);
const AdminZonesPage = lazy(() =>
  import("@/features/admin/pages/AdminZonesPage").then((m) => ({
    default: m.AdminZonesPage,
  })),
);
const AdminHolidayPage = lazy(() =>
  import("@/features/admin/pages/AdminHolidayPage").then((m) => ({
...
const NotificationHistoryPage = lazy(() =>
  import("@/features/notifications/pages/NotificationHistoryPage").then(
    (m) => ({ default: m.NotificationHistoryPage }),
  ),
);
const BusinessAnalyticsPage = lazy(() =>
  import("@/features/analytics/pages/BusinessAnalyticsPage").then((m) => ({
    default: m.BusinessAnalyticsPage,
  })),
);
const BrowsePlansPage = lazy(() =>
  import("@/features/customer/pages/BrowsePlansPage").then((m) => ({
    default: m.BrowsePlansPage,
  })),
);
const SubscriptionDetailsPage = lazy(() =>
  import("@/features/customer/pages/SubscriptionDetailsPage").then((m) => ({
    default: m.SubscriptionDetailsPage,
  })),
);
const SubscriptionWizardPage = lazy(() =>
  import("@/features/customer/pages/SubscriptionWizardPage").then((m) => ({
    default: m.SubscriptionWizardPage,
  })),
);
const PaymentHistoryPage = lazy(() =>
  import("@/features/customer/pages/PaymentHistoryPage").then((m) => ({
    default: m.PaymentHistoryPage,
  })),
);
const ProfilePage = lazy(() =>
  import("@/features/customer/pages/ProfilePage").then((m) => ({
    default: m.ProfilePage,
  })),
);
const CustomerOrderHistoryPage = lazy(() =>
  import("@/features/customer/pages/CustomerOrderHistoryPage").then((m) => ({
    default: m.CustomerOrderHistoryPage,
  })),
);
const CustomerDashboardPage = lazy(() =>
  import("@/features/dashboard/pages/CustomerDashboardPage").then((m) => ({
    default: m.CustomerDashboardPage,
  })),
);
const ProductionBoardPage = lazy(() =>
  import("@/features/kitchen/pages/ProductionBoardPage").then((m) => ({
    default: m.ProductionBoardPage,
  })),
);
const DailyMenuListPage = lazy(() =>
  import("@/features/kitchen/pages/DailyMenuListPage").then((m) => ({
    default: m.DailyMenuListPage,
  })),
);
const DailyMenuEditorPage = lazy(() =>
  import("@/features/kitchen/pages/DailyMenuEditorPage").then((m) => ({
    default: m.DailyMenuEditorPage,
  })),
);
const DeliveryDashboardPage = lazy(() =>
  import("@/features/delivery/pages/DeliveryDashboardPage").then((m) => ({
    default: m.DeliveryDashboardPage,
  })),
);
const DeliveryPartnerPage = lazy(() =>
  import("@/features/delivery/pages/DeliveryPartnerPage").then((m) => ({
    default: m.DeliveryPartnerPage,
  })),
);
const AttendanceDashboardPage = lazy(() =>
  import("@/features/hr/pages/AttendanceDashboardPage").then((m) => ({
    default: m.AttendanceDashboardPage,
  })),
);
const PayrollDashboardPage = lazy(() =>
  import("@/features/hr/pages/PayrollDashboardPage").then((m) => ({
    default: m.PayrollDashboardPage,
  })),
);
const SalaryAdvanceHistoryPage = lazy(() =>
  import("@/features/hr/pages/SalaryAdvanceHistoryPage").then((m) => ({
    default: m.SalaryAdvanceHistoryPage,
  })),
);
const UnifiedDashboardPage = lazy(() =>
  import("@/features/dashboard/pages/UnifiedDashboardPage").then((m) => ({
    default: m.UnifiedDashboardPage,
  })),
);
const TermsOfServicePage = lazy(() =>
  import("@/features/auth/pages/TermsOfServicePage").then((m) => ({
    default: m.TermsOfServicePage,
  })),
);
const PrivacyPolicyPage = lazy(() =>
  import("@/features/auth/pages/PrivacyPolicyPage").then((m) => ({
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            path: "/admin/delivery",
            element: withSuspense(DeliveryDashboardPage),
          },
          ...
          },
          {
            ...
            element: withSuspense(BusinessAnalyticsPage),
          },
          ...
          { path: "/admin/menus", element: withSuspense(DailyMenuListPage) },
          {
            ...
            element: withSuspense(DailyMenuEditorPage),
          },
          {
          ...
          {
            path: "/admin/payments",
            element: withSuspense(PaymentVerificationPage),
          },
          {
          ...
          },
          {
            ...
            element: withSuspense(NotificationHistoryPage),
          },
          {
    ...
    children: [
      {
        ...
        children: [
          ...
          { path: "/customer/plans", element: withSuspense(BrowsePlansPage) },
          {
            ...
            element: withSuspense(SubscriptionDetailsPage),
          },
          {
            path: "/customer/subscribe",
            element: withSuspense(SubscriptionWizardPage),
          },
          {
            path: "/customer/payments",
            element: withSuspense(PaymentHistoryPage),
          },
          {
            path: "/customer/orders",
            element: withSuspense(CustomerOrderHistoryPage),
          },
        ...
        children: [
          {
            ...
            element: withSuspense(ProductionBoardPage),
          },
          { path: "/kitchen/menus", element: withSuspense(DailyMenuListPage) },
          {
            path: "/kitchen/menus/new",
            element: withSuspense(DailyMenuEditorPage),
          },
          {
            path: "/kitchen/menus/:id/edit",
            element: withSuspense(DailyMenuEditorPage),
          },
        ],
      },
