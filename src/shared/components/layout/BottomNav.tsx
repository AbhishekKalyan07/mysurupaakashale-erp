  ...
  return (
    <>
      ...
      <nav
        ...
        className="fixed bottom-0 left-0 right-0 z-40 lg:hidden bg-card/95 backdrop-blur-md border-t border-border"
          ...
          {tabs.map((tab) => (
            ...
            >
              {({ isActive }) => (
                <>
                  {isActive && (
                    <div className="absolute -bottom-[1px] left-1/2 -translate-x-1/2 w-10 h-1 rounded-t-full bg-gold animate-in fade-in" />
                  )}
                  <tab.icon
                    size={24}
