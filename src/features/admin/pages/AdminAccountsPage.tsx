...
export function AdminAccountsPage() {
  ...
  const handleDownloadMonthly = async () => {
    try {
      ...
      const csvString =
        await accountsRepository.generateMonthlyReport(monthStr);
        ...
        actions={
          <div className="flex gap-4">
            <Button
              ...
              variant="secondary"
              className="bg-white/10 text-primary hover:bg-gold/10 hover:text-gold"
            >
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <div className="space-y-6 md:col-span-1">
          ...
          {isLoadingPending ? (
            ...
            <Card
              hoverLift
              className="p-5 border-amber-200/50 bg-gradient-to-br from-background to-amber-50/30 cursor-pointer"
              onClick={() => navigate("/admin/payments")}
            >
        ...
        <div className="md:col-span-2 space-y-6">
          <Card hoverLift className="p-6">
            <div className="mb-6">
              ...
              <p className="text-sm text-text-muted">
                Download system-generated CSV reports
              </p>
            </div>
          ...
          <Card hoverLift className="p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-text-muted">
                  Bill a customer directly for one-time services
                </p>
              </div>
            </div>
