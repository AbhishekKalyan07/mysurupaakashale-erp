      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-10">
          <div className="flex items-center justify-center gap-4 mb-3">
            ...
            <h1 className="text-4xl font-serif font-bold text-[#2D2323]">
              Choose Your Plan
            </h1>
            <Leaf className="text-[#C59A45] w-5 h-5 -rotate-[20deg] opacity-70" />
          </div>
          <p className="text-[#6B5E5E] text-lg">
            Wholesome meals, delivered 3 times every day.
          </p>
        </div>
              ...
              >
                ...
                <div className="relative h-36 w-full bg-gray-200 rounded-t-[22px] overflow-hidden">
                  <img
                    src={
                      isRegular
                        ? "/images/meal_plan_regular.png"
                        : "/images/meal_plan_basic.png"
                    }
                    alt={plan.name}
                  ...
                  <div
                    className="absolute -bottom-4 left-1/2 -translate-x-1/2 text-white p-2 rounded-full border-[4px] border-white shadow-sm"
                ...
                <div className="pt-6 px-5 pb-5 flex-1 flex flex-col">
                  <div className="text-center mb-3">
                    <h2
                      className="text-2xl font-serif mb-0.5"
                      style={{ color: primaryColor }}
                    >
                      {plan.name}
                    </h2>
                    <p className="text-sm text-[#6B5E5E] leading-snug">
                      {plan.description ||
                        "Including 3 times food with 3 times separate delivery."}
                    </p>
                  </div>

                  {/* Price Box */}
                  <div
                    className="rounded-xl py-2 px-2 text-center mb-4"
                  ...
                  >
                    ...
                    <p
                      className="text-[10px] font-semibold uppercase tracking-wide mt-0.5 opacity-80"
                      style={{ color: primaryColor }}
                    >
                  ...
                  <div className="mb-4">
                    ...
                    <div className="grid grid-cols-2 gap-y-3 gap-x-2 text-sm">
                      <div>
                        ...
                        <p className="text-[#6B5E5E] text-sm leading-tight">
                          Daily rotating menu (Idli, dosa, upma, etc.)
                        </p>
                      </div>
                      <div>
                        <h4 className="font-semibold text-[15px] text-[#2D2323] flex items-center gap-1.5 mb-1">
                        ...
                        <ul
                          className={`text-[#6B5E5E] text-sm leading-tight list-disc pl-4 ${isRegular ? "marker:text-[#C59A45]" : "marker:text-[#893131]"}`}
                        >
                          {plan.mealSlots
                      ...
                      <div>
                        ...
                        <p className="text-[#6B5E5E] text-sm leading-tight">
                          3 separate hot-deliveries per day
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        <div className="mt-12 pt-8 border-t border-[#EAE1D8] flex flex-wrap justify-center md:justify-between gap-6 px-4">
          <div className="flex items-center gap-3 w-[45%] md:w-auto">
            ...
            <div>
              <h5 className="text-sm font-bold text-[#2D2323]">
                100% Homemade
              </h5>
              <p className="text-[10px] text-[#6B5E5E] mt-0.5">
          ...
          <div className="flex items-center gap-3 w-[45%] md:w-auto">
            ...
            <div>
              ...
              <p className="text-[10px] text-[#6B5E5E] mt-0.5">
                Hot & timely delivery right to your door.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 w-[45%] md:w-auto">
            ...
            <div>
              ...
              <p className="text-[10px] text-[#6B5E5E] mt-0.5">
                Pause or resume your plan as per your need.
              </p>
            </div>
          </div>
