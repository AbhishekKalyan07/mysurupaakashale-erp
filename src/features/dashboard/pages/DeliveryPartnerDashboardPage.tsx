...
export function DeliveryPartnerDashboardPage() {
  ...
  const {
    ...
    loading,
    error,
  } = usePartnerDashboardStats(firebaseUser?.uid, today);
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          <Card className="p-5 flex flex-col items-center justify-center text-center space-y-2 border-primary/20 bg-primary/5">
            ...
            <p className="text-3xl font-bold text-primary font-data">
              {todayStats.assigned}
            </p>
          </Card>
          ...
          <Card className="p-5 flex flex-col items-center justify-center text-center space-y-2 border-success/20 bg-success-subtle">
            ...
            <p className="text-xs text-success-dark font-bold uppercase tracking-wider">
              Delivered
            </p>
            <p className="text-3xl font-bold text-success-dark font-data">
          ...
          <Card className="p-5 flex flex-col items-center justify-center text-center space-y-2 border-warning/20 bg-warning-subtle">
            ...
            <p className="text-xs text-warning-dark font-bold uppercase tracking-wider">
              Remaining
            </p>
            <p className="text-3xl font-bold text-warning-dark font-data">
          ...
          <Card className="p-5 flex flex-col items-center justify-center text-center space-y-2 border-danger/20 bg-danger-subtle">
            ...
            <p className="text-xs text-danger-dark font-bold uppercase tracking-wider">
              Failed
            </p>
            <p className="text-3xl font-bold text-danger-dark font-data">
              {todayStats.failed}
            </p>
          </Card>
          ...
          <Card className="p-5 flex flex-col items-center justify-center text-center space-y-2 border-border bg-surface-2">
            ...
            <p className="text-3xl font-bold text-text-muted font-data">
