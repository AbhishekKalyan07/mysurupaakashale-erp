    ...
    <AuthLayout>
      {signupStep === 1 && pendingGoogleUser && (
        <form onSubmit={handlePhoneStepSubmit} className="flex flex-col gap-5 w-full relative z-10">
          <div className="mb-2">
            <h2 className="font-display text-[28px] font-bold text-leaf-700 mb-1 leading-tight">
              Complete Profile
            </h2>
          ...
          <div className="flex flex-col gap-1">
            <div className="relative">
              ...
              <input
                ...
                className={`h-14 w-full rounded-xl border border-rice-300 bg-white pl-12 pr-4 text-[15px] text-ink-900 placeholder:text-ink-400 transition-colors focus:outline-none focus:ring-1 focus:border-leaf-700 focus:ring-leaf-700 shadow-sm ${
          ...
          <Button 
            type="submit" 
            className="w-full h-14 rounded-xl bg-leaf-700 hover:bg-leaf-800 text-white text-[17px] font-semibold transition-colors mt-2 shadow-sm"
          >
        ...
        <form onSubmit={handleCompleteGoogleSignup} className="flex flex-col gap-5 w-full relative z-10">
            ...
            <div className="flex flex-col gap-1">
              <div className="relative">
                ...
                <input
                  ...
                  className={`h-14 w-full rounded-xl border border-rice-300 bg-white pl-12 pr-12 text-[15px] text-ink-900 placeholder:text-ink-400 transition-colors focus:outline-none focus:ring-1 focus:border-leaf-700 focus:ring-leaf-700 shadow-sm ${
          ...
          <div className="flex gap-2">
            ...
            <Button 
              ...
              onClick={handleCancelGoogleSignup}
              variant="ghost"
              className="w-1/2 h-12 rounded-xl text-danger hover:text-leaf-800 transition-colors text-[15px] font-medium"
            >
              Cancel
            </Button>
          </div>
      ...
      {signupStep === 0 && (
        <form onSubmit={handleSubmit(onSubmit)} noValidate className="flex flex-col gap-5 w-full relative z-10">
          <div className="mb-3 pr-12">
            <h2 className="font-display text-[32px] font-bold text-leaf-700 mb-1 leading-tight">
              Create Your Account
            </h2>
            <p className="text-[15px] text-ink-700 font-medium pr-8">
          ...
          <div className="flex flex-col gap-1 mt-1">
            <label className="flex items-start gap-3 cursor-pointer text-[13.5px] text-ink-700 font-medium">
              <div className="relative flex items-center">
                <input
                  type="checkbox"
                  className="peer mt-0.5 h-5 w-5 appearance-none rounded-[4px] border-2 border-ink-300 bg-white checked:border-leaf-700 checked:bg-leaf-700 focus:outline-none focus:ring-2 focus:ring-leaf-700/30 transition-all cursor-pointer"
                  {...register('agreed')}
                />
              ...
              <span className="leading-tight pt-1">
                I agree to the{' '}
                <a href="#" className="text-leaf-700 font-bold hover:underline">Terms of Service</a> and{' '}
                <a href="#" className="text-leaf-700 font-bold hover:underline">Privacy Policy</a>
              </span>
            </label>
            {errors.agreed && (
          ...
          <div className="relative flex items-center justify-center my-2">
            ...
            <span className="absolute bg-rice-50 px-4 text-[13px] font-bold text-ink-600 font-sans uppercase">
              OR
            </span>
          </div>
      ...
      {signupStep === 0 && (
        <div className="mt-2 text-center text-[15px] font-medium text-ink-700">
          ...
          <Link to="/login" className="font-bold text-leaf-700 hover:underline">
            Sign In
          </Link>
        </div>
      )}
