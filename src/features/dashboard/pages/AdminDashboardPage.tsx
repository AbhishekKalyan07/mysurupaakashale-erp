...
export function AdminDashboardPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 mb-8">
          ...
          <MetricCard
            ...
            color={
              (metrics?.todayOrders.failedDeliveries ?? 0) === 0
                ? "mint"
                : "rose"
            }
          />
          ...
          <MetricCard
            ...
            icon={
              <ShieldAlert
                size={24}
                className={metrics?.openComplaints ? "text-warning" : ""}
              />
            }
        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-4">
            ...
            <MetricCard
              ...
              icon={
                <Activity
                  size={24}
                  className={metrics.kitchenSLA < 95 ? "text-danger" : ""}
                />
              }
            ...
            <MetricCard
              ...
              icon={
                <Activity
                  size={24}
                  className={metrics.deliverySLA < 95 ? "text-danger" : ""}
                />
              }
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <MetricCard
              ...
              icon={<Activity size={24} />}
              color={
                metrics.driverStats.utilizationPercent >= 80 ? "mint" : "blue"
              }
            />
            <MetricCard
      ...
      {metrics &&
        metrics.generationRuns &&
        metrics.generationRuns.length > 0 && (
          <div>
            <h2 className="text-xl font-display font-bold text-primary mb-6 flex items-center gap-2">
              <Activity className="text-gold" size={24} />
              ...
              {metrics.generationRuns.map((run) => (
                <PremiumCard key={run.id} className="p-6 border-primary/20">
                  <div className="flex justify-between items-start mb-4">
                    <h3 className="font-bold text-primary capitalize font-display text-lg">
                      {run.mealType} Generation
                    </h3>
                    <div
                  ...
                  <div className="space-y-2 text-sm font-sans mb-4">
                    ...
                    <div className="flex justify-between pb-2">
                      ...
                      <span
                        className={`font-bold ${run.ordersFailed && run.ordersFailed > 0 ? "text-danger" : "text-primary"}`}
                      >
                        {run.ordersFailed || 0}
                      </span>
                    </div>
                    ...
                    <p>
                      ...
                      {run.startedAt
                        ? typeof run.startedAt === "string"
                          ...
                          : (run.startedAt as any).toDate().toLocaleTimeString()
                        : "N/A"}
                    </p>
                    {run.completedAt && (
                      <p>
                  ...
                  {run.error && (
                    <div
                      className="mt-3 text-xs bg-danger/10 text-danger p-3 rounded-xl border border-danger/20 font-bold overflow-hidden text-ellipsis whitespace-nowrap"
                      title={run.error}
                    >
                      Error: {run.error}
                    </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className="text-sm text-text-muted mt-2">
              Provision and manage Kitchen, Delivery, and Accounts staff roles.
            </p>
          </PremiumCard>
          ...
          >
            ...
            <p className="text-sm text-text-muted mt-2">
              Configure delivery radius, operational holidays, and global
              parameters.
            </p>
          </PremiumCard>
          ...
          >
            ...
            <p className="text-sm text-text-muted mt-2">
              Review operational actions, payments, and workflow transitions.
            </p>
          </PremiumCard>
        </div>
      </div>
