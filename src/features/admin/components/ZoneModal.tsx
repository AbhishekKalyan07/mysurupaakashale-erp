...
const zoneSchema = z.object({
  id: z
    ...
    .regex(
      /^[A-Z0-9_]+$/,
      "Only uppercase letters, numbers, and underscores allowed (e.g. ZONE_01)",
    ),
          ...
          >
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-ink-500">
                Orders with these pincodes will be routed to this zone.
              </p>
              {errors.pincodes && (
                <p className="text-xs text-danger">{errors.pincodes.message}</p>
              )}
            </div>
            ...
            <div className="flex items-center gap-2 pt-2">
              <input
                ...
                id="isActive"
                {...register("isActive")}
                className="w-4 h-4 text-leaf-600 rounded border-rice-300 focus:ring-leaf-600"
              />
              <label
                htmlFor="isActive"
