        ...
        <div className="grid gap-6 md:grid-cols-3">
                ...
                <div className="pt-2">
                  ...
                  <div className="h-3 w-full rounded-full bg-primary/10 overflow-hidden shadow-inner">
                    <div
                      ...
                      style={{
                        width: `${dashboard?.totalOrders ? Math.round(((dashboard.completedCount || 0) / dashboard.totalOrders) * 100) : 0}%`,
                      }}
                    />
                  </div>
                </div>
          ...
          <div className="md:col-span-2 space-y-6">
            <Card hoverLift className="p-8">
              <div className="flex items-center justify-between mb-8">
                <div>
                  ...
                  <p className="text-sm font-sans text-text-muted mt-1">
                    Live progress of kitchen tasks
                  </p>
                </div>
                <Button
                  variant="primary"
              ...
              <div className="grid gap-6 sm:grid-cols-3">
                {(["breakfast", "lunch", "dinner"] as MealType[]).map(
                  (meal) => {
                    const summary = dashboard?.byMealType[meal] || {
                      total: 0,
                      scheduled: 0,
                      packing: 0,
                      readyForPickup: 0,
                    ...
                    const isDone =
                      summary.total > 0 &&
                      summary.readyForPickup + summary.pickedUp ===
                        summary.total;

                    return (
                      <div
                        key={meal}
                        className="space-y-5 p-5 rounded-2xl border border-gold/20 bg-gradient-to-b from-background to-primary/5 transition-all hover:border-gold/40"
                      >
                        <div className="flex justify-between items-center border-b border-gold/10 pb-3">
                          ...
                          {isDone ? (
                            ...
                            <span className="text-xs font-bold text-text-muted bg-white px-2 py-1 rounded-md shadow-sm border border-gold/10">
                              {summary.total} Total
                            </span>
                          )}
                        </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <Card
                hoverLift
                className="p-6 flex items-start gap-5 cursor-pointer group"
              ...
              >
                ...
                <div>
                  <h4 className="font-display font-bold text-lg text-primary mb-1.5 group-hover:text-gold transition-colors">
                    Manage Orders
                  </h4>
                  <p className="text-sm text-text-muted font-sans leading-relaxed">
                    View and override order workflows, reassign delivery zones,
                    and track delays.
                  </p>
                </div>
              </Card>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-text-muted font-sans leading-relaxed">
                    Analyze which meals are most popular and plan tomorrow's
                    menu schedule.
                  </p>
                </div>
              </Card>
