          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-ink-500 font-sans mt-1">
                Unlocking production allows kitchen staff to modify order
                statuses again. This action will be recorded in the global audit
                log.
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label
                ...
                className="block text-sm font-bold text-ink-900 mb-1"
              >
