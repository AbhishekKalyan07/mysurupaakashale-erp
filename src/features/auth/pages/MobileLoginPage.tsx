    ...
    <MobileAuthLayout>
      ...
      <div className="w-full bg-white/40 p-5 rounded-[24px] backdrop-blur-sm border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)] animate-in fade-in duration-500">
        {forgotPasswordMode ? (
          ...
          >
            <div>
              <h1 className="font-display text-2xl font-bold text-[#2c150c] tracking-tight">
                Reset password
              </h1>
              <p className="mt-1 text-sm text-[#6e584f] font-medium">
            ...
            {formError && (
              <p
                role="alert"
                className="text-sm font-medium text-red-600 bg-red-50 rounded-lg px-3 py-2 text-center border border-red-100"
              >
                {formError}
              </p>
            )}
          ...
          >
            ...
            <p className="mt-2 text-center text-sm text-[#6e584f] font-medium">
        ...
        <p className="mt-5 text-[10px] text-[#5a4a44] text-center">
          ...
          <Link
            to="/terms"
            className="font-semibold text-[#5c1417] hover:underline"
          >
            Terms of Service
          </Link>{" "}
          and{" "}
