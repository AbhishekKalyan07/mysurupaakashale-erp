  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
      ...
      <Card className="p-4 flex flex-col items-center justify-center text-center bg-rice-50/50">
        ...
        <span className="text-2xl font-bold font-display text-info">
      ...
      <Card className="p-4 flex flex-col items-center justify-center text-center bg-rice-50/50">
        ...
        <span className="text-2xl font-bold font-display text-danger">
          {summary.failed}
        </span>
        <span className="text-xs text-text-muted font-medium uppercase tracking-wider">
          Failed
      ...
      <Card className="p-4 flex flex-col items-center justify-center text-center bg-gold/10 border-gold/30">
        ...
        <span className="text-xs text-gold/80 font-medium uppercase tracking-wider mt-1">
          Completion
        </span>
      </Card>
    </div>
