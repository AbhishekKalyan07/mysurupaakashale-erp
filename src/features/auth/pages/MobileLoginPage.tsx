          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate className="w-full flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3 mt-1">
              <div className="flex flex-col gap-1">
                ...
                {errors.email && <p className="text-xs text-red-600 ml-2">{errors.email.message}</p>}
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                {errors.password && <p className="text-xs text-red-600 ml-2">{errors.password.message}</p>}
              </div>
            </div>
